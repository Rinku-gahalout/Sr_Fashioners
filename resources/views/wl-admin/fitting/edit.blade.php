...
<div class="form-card">
    ...
    <div class="form-card-header">
        <h5>
            ...
            Edit Fitting Details
        </h5>
    </div>

    <form action="{{ route('fittings.update', $fitting->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    name="sort_order"
                    class="form-control"
                    value="{{ old('sort_order', $fitting->sort_order) }}">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-control">
                    <option value="1" {{ $fitting->status == 1 ? 'selected' : '' }}>
                        Active
                    </option>

                    <option value="0" {{ $fitting->status == 0 ? 'selected' : '' }}>
                        Inactive
                    </option>
                </select>
            </div>
