    ...
    <div class="container">
        <div class="header-wrapper">
            ...
            <div class="logo-area">
                ...
                <a href="{{ url('/') }}">
                    <!-- Desktop Logo -->
                    <img src="{{ asset('images/logo.png') }}" alt="Fashioners" class="desktop-logo">

                    <!-- Mobile Logo -->
                    <img src="{{ asset('images/SR final logo for mobile view.png') }}" alt="Fashioners"
                        class="mobile-logo">
                </a>
            ...
            <div class="header-icons">
                ...
                <div class="search-wrapper">
                    ...
                    <a href="{{ route('user.wishlist')}}"><i class="far fa-heart"></i></a>
                    <a href="{{ route('cart.list') }}"><i class="fas fa-shopping-cart"></i></a>
                </div>
